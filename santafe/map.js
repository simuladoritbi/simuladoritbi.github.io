...
const camadaImagemRecente = new ol.layer.Tile({
    source: new ol.source.TileWMS({
        url: 'https://plataforma.nacidade.com.br/geoserver/santafe-ctm-3/wms',
        params: {
...
const camadaPGV = new ol.layer.Tile({
    source: new ol.source.TileWMS({
        ...
        params: {
            'LAYERS': 'drz:pgv_rural_imovel_santafe',
            'FORMAT': 'image/png',
            'TRANSPARENT': true
        }
    }),
...
const camadaAmostras = new ol.layer.Tile({
    source: new ol.source.TileWMS({
        url: 'https://pedromiguez.com.br/geoserver/wms',
        params: {
            'LAYERS': '	drz:pesquisa_imobiliaria_santafe',
            'FORMAT': 'image/png',
            'TRANSPARENT': true
        }
    }),
...
const map = new ol.Map({
    ...
    view: new ol.View({
        center: ol.proj.fromLonLat([-51.813542, -23.07]),
        zoom: 12
    })
});
...
map.on('singleclick', async function (event) {
    ...
    const urlPGV = camadaPGV.getSource().getFeatureInfoUrl(
        ...
        {
            'INFO_FORMAT': 'application/json',
            'QUERY_LAYERS': 'drz:pgv_rural_imovel_santafe',
            'FEATURE_COUNT': 1
        }
    );
